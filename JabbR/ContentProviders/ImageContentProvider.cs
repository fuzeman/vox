...
namespace JabbR.ContentProviders
{
    public class ImageContentProvider : CollapsibleContentProvider
    {
        ...
        {
            string format = @"<a rel=""nofollow external"" target=""_blank"" href=""{0}"" class=""imageContent""><img src=""{0}"" /></a>";
            if (_settings.ProxyImages)
            {
                ...
                {
                    format = @"<a rel=""nofollow external"" target=""_blank"" href=""{0}"" class=""imageContent""><img src=""proxy?url={0}"" /></a>";
                }
            }
