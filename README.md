...
Vox is a chat application forked from [JabbR](https://github.com/JabbR/JabbR/) and built with ASP.NET using SignalR.

Vox includes a number of extra features *(not available in JabbR upstream yet)*:
