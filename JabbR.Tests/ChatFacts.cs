...
namespace JabbR.Test
{
    public class ChatFacts
    {
        ...
        public static TestableChat GetTestableChat(string connectionId, StateChangeTracker clientState, ChatUser user, IDictionary<string, Cookie> cookies)
        {
            ...
            var chat = new TestableChat(resourceProcessor, pushNotification, chatService, repository, connection, settings);
        ...
        public class TestableChat : Chat
        {
            ...
            public TestableChat(Mock<ContentProviderProcessor> mockedResourceProcessor, Mock<PushNotificationService> mockedPushNotification, Mock<IChatService> mockedChatService, IJabbrRepository repository, Mock<IConnection> connection, ApplicationSettings settings)
